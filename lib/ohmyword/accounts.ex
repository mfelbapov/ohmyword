defmodule Ohmyword.Accounts do
  @moduledoc """
  ...
  alias Ohmyword.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Ohmyword.Accounts.User.registration_changeset/3` for a list of supported options.
  ...
  See `Ohmyword.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Ohmyword.Accounts.User.password_changeset/3` for a list of supported options.
