defmodule BoilerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BoilerWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BoilerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BoilerWeb.Gettext, "errors", msg, opts)
    end
  end
