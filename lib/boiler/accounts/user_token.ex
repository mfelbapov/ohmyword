defmodule Boiler.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Boiler.Accounts.UserToken

  @hash_algorithm :sha256
  @rand_size 32

  # It is very important to keep the confirmation token expiry short,
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Boiler.Accounts.User
