defmodule OhmywordWeb.AdminDashboardLive do
  ...
  def mount(_params, _session, socket) do
    user_count = Ohmyword.Repo.aggregate(Ohmyword.Accounts.User, :count, :id)

    admin_count =
      from(u in Ohmyword.Accounts.User, where: u.role == :admin)
      |> Ohmyword.Repo.aggregate(:count, :id)
