defmodule Boiler.AITest do
  use Boiler.DataCase, async: true
  ...
  describe "analyze_issues/2" do
    ...
    test "returns error when API key is not configured" do
      ...
      original_config = Application.get_env(:boiler, :openai)
      Application.put_env(:boiler, :openai, [])
      ...
      if original_config, do: Application.put_env(:boiler, :openai, original_config)
